...
Most prompts were AI generated. See later section and Gemini transcript for more info.
...
%}
{% include an-img.html model="Modjourney 6"
src="https://cdn.midjourney.com/cd3dd925-18df-4a7f-abc8-32386bfff7e7/0_0.webp"
href="https://www.midjourney.com/jobs/fcad3255-5408-42c7-8af8-dc093f9136aa?index=0"
prompt="A tulip in a glass vase on a table, sunlight streaming through a window minimalist flat illustration for clean website"
%}
{% include an-img.html model="Modjourney 6"
...
%}
{% include an-img.html model="Imagen 2 (ImageFX)"
src="https://ai.nafsadh.art/img/tulip/dress-imgfx.png"
prompt="A tulip dress with the petals forming a flowing skirt, haute couture illustration"
%}
{% include an-img.html model="Imagen 2 (ImageFX)"
...
Using Bard
<div class="row row-cols-2 row-cols-md-3">
{% include dir-img.html folder="/img/tulip/imagen" imagen="2" bard="665fa1ae4d39" %}
</div>


## DALL·E 3
DALL·E 3 generations using ChatGPT

<div class="row row-cols-1 row-cols-md-2">
{% include dir-img.html folder="/img/tulip/dall-e/l" dalle="3" %}
</div>
<div class="row row-cols-2 row-cols-md-3">
{% include dir-img.html folder="/img/tulip/dall-e/s" dalle="3" %}
</div>
<div class="row row-cols-2 row-cols-md-4">
{% include dir-img.html folder="/img/tulip/dall-e/p" dalle="3" %}
</div>
